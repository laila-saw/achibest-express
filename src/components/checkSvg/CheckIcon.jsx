...
const CheckIcon = () => {
    return (
        <svg
            fill="white"
            style={{background:"#71d648", borderRadius:"50%", overflow:"hidden"}}
