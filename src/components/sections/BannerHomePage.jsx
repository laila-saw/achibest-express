...
import backGroundImage from '../../assets/achibestBg.png'
import videoControllerIcon from "../../assets/icons - svg/Blanc/24 px/Achibest-icon-Play.svg"
import closeIcon from "../../assets/icons - svg/Blanc/24 px/Achibest-icon-Close.svg"
const BannerHomePage = () => {
  ...
  return (
    <div className='banner bannerHomePage pl-[75px] w-full h-[calc(100vh+76px)]'>
        <div className="bannerWrapper pl-6 sm:pl-[85px]  w-full h-full relative flex items-center" style={{backgroundImage:`url(${backGroundImage})`, backgroundSize:"cover" }}>
            <div className="bannerContent">
                ...
                <div className="videoBtn flex items-center gap-2 absolute bottom-[100px]">
                    <div className="cursor-pointer videoControllerBtn  border-orange" onClick={()=>setPopupV(true)}><img className='videoControllerIcon bg-orange' src={videoControllerIcon} alt="" /></div>
       ...
       <span onClick={()=>setPopupV(false)} className='absolute top-6 right-5 cursor-pointer'><img className="w-10 h-10  " src={closeIcon} alt="" /></span>
